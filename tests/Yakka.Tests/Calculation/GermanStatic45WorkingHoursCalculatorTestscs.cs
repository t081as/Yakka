...
{
    /// <summary>
    /// Contains unit tests of the <see cref="GermanStatic45WorkingHoursCalculator"/> class.
    /// </summary>
    [TestClass]
    public class GermanStatic45WorkingHoursCalculatorTestscs
    {
        ...
        public void CalculateTest()
        {
            ...
            start = end - TimeSpan.FromHours(6) - TimeSpan.FromMinutes(45);
            result = calulator.Calculate(start, end);
            ...
            start = end - TimeSpan.FromHours(7) - TimeSpan.FromMinutes(45);
            result = calulator.Calculate(start, end);
