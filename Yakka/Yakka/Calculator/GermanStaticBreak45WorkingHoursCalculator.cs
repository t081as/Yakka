...
{
    /// <summary>
    /// Represents an implementation of <see cref="IWorkingHoursCalculator"/> calculating the break using
    /// the following rule:
    /// Break: 45 minutes when working more than 6 hours.
    /// </summary>
    [Serializable]
    public class GermanStaticBreak45WorkingHoursCalculator : WorkingHoursCalculator
    {
        #region Methods
        ...
        public override string GetDescription(CultureInfo culture)
        {
            ...
            {
                case "de":
                    return "Deutschland: Statische Pause (45 min > 6h Arbeit)";

                default:
                    return "Germany: static break (45 min > 6h work)";
            }
        }
